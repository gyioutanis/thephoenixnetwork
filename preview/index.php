<?php include 'header.php'; ?>
    ...
    <main class="home">
                    ...
                    <div class="home-intro gen-width gen-rim white-font">
                        <div class="home-intro-inner">
                            <div class="home-intro__text" style="padding-top:110px;max-width: 800px;">
                                ...
                                <p style="margin-bottom:10px;max-width:700px;">Green Power Coin (GPC) is the adopted token
                                    of the Green Power
                ...
                <div class="home-app-inner home-press gen-width gen-rim">
                    <div class="home-press-inner px-6 py-10">
                        ...
                        <div class="home-app__text">
                            ...
                            <p>
                                GPC is the <span style="color: #FFB400;">adopted token</span> of the Green Power Platform,
                                and GPC is required by buy NFTs for green mining, to vote in the DAO and to stake to unlock
                                play to earn games.
                            </p>
                        </div>
                    ...
                    <div class="home-benefits__blocks">
                        <div class="home-benefits__blocks__item"
                            ...
                            <div class="home-benefits__blocks__item__text">
                                <h4 class="text-6xl capitalize">How to get <span class="gen-font-gradient">$GPC</span></h4>
                                <p style="max-width: 700px;">You can buy $GPC on a DEFI exchange, stake it in the Green
                                    Power App to unlock play to earn games, or you can buy Green Miner NFTs and help build
        ...
        <!--                            <div class="home-benefits__blocks__item__text">-->
        <!--                                <h5>Community</h5>-->
        <!--                                <p>$GPC has a vibrant enthusiastic community of HODLers worldwide, growing each day</p>-->
        <!--                            </div>-->
        <!--                        </div>-->
        <!---->
        <!--                        <div class="home-benefits__blocks__item">-->
        ...
        <!--                                <p>$GPC is being accepted by clubs and businesses worldwide because of its fast-->
        ...
        <!--                                <p>$GPC is also being used as a secure store of wealth because of its limited supply,-->
        ...
        <section class="home-app-wrap" style="background-image: url('assets/img/temp/star_background.jpg');">
            <div class="home-app gen-width gen-rim white-font">
                <div class="home-app-inner">
                    ...
                    <div class="home-app__img">
                        <img srcset="assets/img/temp/home-app-phones.png 1x, assets/img/temp/home-app-phones@2x.png 2x"
                             src="assets/img/temp/home-app-phones.png" alt="">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="dark:bg-gray-900 " style="overflow-anchor: none;">
            <div class="container px-6 py-10 mx-auto max-w-7xl">
                <div class="lg:flex lg:items-center">
                    <div class="w-full space-y-12">
                        <div>
                            <h1 class="text-6xl font-semibold text-gray-800 capitalize dark:text-white">Platform<br> <span
